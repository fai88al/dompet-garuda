 ...
 * @param receiverDeviceId the receiver's registered device, if any — used for the best-effort
 *                         {@code payment-received} MQTT hint; {@code null} if none registered
 ...
 */
public record TransferOutcome(int status, TransferResponse body, UUID receiverDeviceId, boolean newlyProcessed) {}
